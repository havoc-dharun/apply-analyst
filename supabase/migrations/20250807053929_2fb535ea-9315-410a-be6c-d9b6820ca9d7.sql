-- Fix NULL hr_user_id values in jobs table and add constraints
-- First, let's see if there are any jobs with NULL hr_user_id
-- We'll add a NOT NULL constraint to prevent future NULL values

-- Add NOT NULL constraint to hr_user_id column
