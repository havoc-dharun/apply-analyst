...
const AIRecruitmentAssistant: React.FC<AIRecruitmentAssistantProps> = ({
  ...
  return <Card className="shadow-soft h-[600px] flex flex-col">
      <CardHeader className="bg-gradient-card border-b">
        <CardTitle className="flex items-center gap-2 mx-0 px-0">
      ...
      <CardContent className="flex-1 flex flex-col p-0">
        ...
        <div className="border-t p-4">
          <div className="flex gap-2">
            ...
            <Button onClick={handleSendMessage} disabled={!currentInput.trim() || isProcessing} size="sm" className="px-4 text-base my-[12px]">
              Send
            </Button>
          </div>
        </div>
